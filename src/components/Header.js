            ...
            <div className="max-w-screen-xl mx-auto flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8">
                    <ul className="flex items-center gap-6">
                        <li>
                            <a href="/restaurant" className="text-base font-medium text-gray-700 hover:text-gray-900 transition-colors duration-200">
                                Add Restaurant
                            </a>
                        </li>
                        <li>
                            <a href="/restaurantOrders" className="text-base font-medium text-gray-700 hover:text-gray-900 transition-colors duration-200">
                                Orders
                            </a>
                        </li>
